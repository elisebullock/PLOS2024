...
sm = cmdstanpy.CmdStanModel(stan_file=paras.stanloc+"linear.stan")
...
data_dict = {
    ...
    "gamma_data" : paras.gammaL,
    "fs_data" : paras.fsL,
    "beta_data" : paras.beta,
    "Source_data" : paras.SourceL,
    "eff_data" : paras.eff,
    "mu_data" : paras.mu,

    "Source_hi":paras.SourceL_hi,
    "Source_lo":paras.SourceL_lo,
        
    }

init_d = {

    "Source" : paras.SourceL,
    "mu" : paras.mu,
...
cmdstanpy.write_stan_json(paras.filelocation+"linear.json", data_dict)

sam = sm.sample(
    data=paras.filelocation+"linear.json", 
    chains=5, 
    parallel_chains=5,
    refresh=5,
    inits=init_d,
...
import pickle
with open(paras.filelocation+"linear.pkl", 'wb') as f:
    pickle.dump(sam, f)
